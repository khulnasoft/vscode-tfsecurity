...
export class TfsecurityHelpProvider implements WebviewViewProvider {
  ...
  update(item: TfsecurityTreeItem | null) {
...
This check may no longer be valid. Check your tfsecurity is the latest version.
`;
      return;
    }

    if (item.contextValue === "TFSECURITY_CODE") {
      this.view.html = `
